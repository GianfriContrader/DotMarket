...
namespace DotMarket.Migrations
{
    ...
    [Migration("20230104090056_ControlValidatorAdded")]
    partial class ControlValidatorAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DotMarket.Models.InvoicePDF", b =>
                {
                    ...
                    b.Property<float>("LoadingStatus")
                        .HasColumnType("REAL");
            ...
            modelBuilder.Entity("DotMarket.Models.ProductKart", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ProductsKart", (string)null);
                });
            ...
            modelBuilder.Entity("DotMarket.Models.Order", b =>
                {
                    b.HasOne("DotMarket.Models.Kart", "Kart")
                        .WithOne("Order")
                        .HasForeignKey("DotMarket.Models.Order", "KartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DotMarket.Models.Payment", "Payment")
                        .WithOne("Order")
                        .HasForeignKey("DotMarket.Models.Order", "PaymentId")
            ...
            modelBuilder.Entity("DotMarket.Models.Payment", b =>
                {
                    ...
                    b.HasOne("DotMarket.Models.InvoicePDF", "InvoicePDF")
                        .WithOne("Payment")
                        .HasForeignKey("DotMarket.Models.Payment", "InvoiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
