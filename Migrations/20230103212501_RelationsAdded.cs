        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LoadingStatus = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AddressProfile", x => new { x.AddressesId, x.ProfilesId });
                    table.ForeignKey(
                        name: "FK_AddressProfile_Addresses_AddressesId",
                        column: x => x.AddressesId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AddressProfile_Profiles_ProfilesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataPayments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DataPayments_Profiles_ProfileId",
                        column: x => x.ProfileId,
                        principalTable: "Profiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Karts_Profiles_ProfileId",
                        column: x => x.ProfileId,
                        principalTable: "Profiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Payments_DataPayments_DataPaymentId",
                        column: x => x.DataPaymentId,
                        principalTable: "DataPayments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Payments_InvoicesPDF_InvoiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    QtyToBuy = table.Column<int>(type: "int", nullable: false),
                    ProductId = table.Column<long>(type: "bigint", nullable: false),
                    KartId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductsKart", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductsKart_Karts_KartId",
                        column: x => x.KartId,
                        principalTable: "Karts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductsKart_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CodeOrd = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsFastDelivery = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AddressProfile_ProfilesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DataPayments_Id",
                table: "DataPayments",
                column: "Id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DataPayments_ProfileId",
                table: "DataPayments",
                column: "ProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductsKart_Id",
                table: "ProductsKart",
                column: "Id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProductsKart_KartId",
                table: "ProductsKart",
                column: "KartId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductsKart_ProductId",
                table: "ProductsKart",
                column: "ProductId");
